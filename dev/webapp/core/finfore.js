...
// Load Core Templates
.then('//webapp/views/desktop.tmpl', '//webapp/views/tab-view.tmpl', '//webapp/views/login.tmpl', '//webapp/views/profile.tmpl', '//webapp/views/panel.controlgroup.tmpl', '//webapp/views/manage.tmpl', '//webapp/views/manage.feed-infos.tmpl', '//webapp/views/manage.panels.tmpl', '//webapp/views/manage.source.tmpl', '//webapp/views/signup.tmpl', '//webapp/views/addcompany.tmpl', '//webapp/views/help.tmpl')
// Load Core CSS
