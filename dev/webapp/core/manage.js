	...
	var panels = {
		create: function(params) {
			...
			if(params.category == 'twitter' || params.category == 'linkedin' || params.category == 'portfolio') {
				...
				var callbackUrl = finforeAppUrl + '/authorize.php',
		...
		revalidate: function(params) {
			...
			if(params.category == 'twitter' || params.category == 'linkedin') {
				...
				var authWindow = window.open(finforeBaseUrl + '/feed_accounts/' + params.category + '/auth?auth_token=' + finfore.data.user.single_access_token + '&auth_secret=' + finfore.data.user.persistence_token + '&feed_account_id=' + feedAccountId + '&callback=' + finforeAppUrl + '/authorize.php', '_blank', 'resizable=yes,scrollbars=yes,status=yes');
