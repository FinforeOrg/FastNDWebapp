...
mejs.HtmlMediaElementShim = {
	...
	createErrorMessage: function(htmlMediaElement, options, downloadUrl, poster) {
		...
		// Added target="_blank" - Ionut Colceriu / BarandiSolutions.com
		errorContainer.innerHTML = (poster !== '') ?
			'<a href="' + downloadUrl + '" target="_blank"><img src="' + poster + '" /></a>' :
			'<a href="' + downloadUrl + '" target="_blank"><span>Download File</span></a>';
